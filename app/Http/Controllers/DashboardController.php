...
class DashboardController extends Controller
{
    ...
    public function getSalesDataForChart()
    {
        ...
        // Buscar os dados de vendas mensais para o ano atual
        ...
        // Criar um array com 12 posições para armazenar os dados de vendas mensais
        $salesData = array_fill(0, 12, 0);

        // Percorrer os dados de vendas mensais e preencher o array de vendas
        foreach ($monthlySalesData as $data) {
            $salesData[$data->month - 1] = $data->total_sales;
        }

        // Retornar os dados de vendas mensais para o gráfico de vendas
